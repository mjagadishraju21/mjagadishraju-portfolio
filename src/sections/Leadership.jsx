...
function Leadership() {
  ...
  return (
    <section
      id="leadership"
      className="min-h-screen bg-black text-white px-4 sm:px-6 md:px-8 lg:px-12 py-20 md:py-24 relative overflow-hidden border-b border-white/5"
    >
      ...
      <motion.div
        ...
        className="absolute top-20 left-10 w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72 bg-cyan-500 rounded-full blur-3xl"
      />
      ...
      <motion.div
        ...
        className="absolute bottom-20 right-10 w-48 h-48 sm:w-60 sm:h-60 md:w-72 md:h-72 bg-purple-500 rounded-full blur-3xl"
      />
        ...
        <div className="space-y-6 md:space-y-8">
          ...
          {leadershipItems.map((item, index) => (
            ...
            <motion.div
              ...
              className="relative backdrop-blur-xl bg-white/5 border border-cyan-400/20 rounded-3xl p-5 sm:p-6 md:p-8 overflow-hidden hover:border-cyan-400/50 transition duration-300 group shadow-[0_0_30px_rgba(34,211,238,0.08)]"
            >
              ...
              <div className="relative z-10 flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div className="flex-1 text-center sm:text-left">
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-4">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold group-hover:text-cyan-400 transition duration-300 break-words">
                      {item.title}
                    </h3>
                    ...
                    <motion.span
                      ...
                      className="w-fit mx-auto sm:mx-0 px-4 py-2 backdrop-blur-md bg-purple-500/10 border border-purple-400/50 rounded-full text-xs sm:text-sm text-purple-300 hover:bg-purple-500/20 transition duration-300"
                    >
                      {item.highlight}
                    </motion.span>
